...
import 'package:fue_connect/screens/auth/terms_and_conditions_screen.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    final String fullEmail = _emailController.text.trim();

    final emailParts = fullEmail.split('@');

    final username = emailParts.first;

    final domain = emailParts.length > 1 ? emailParts.last : "";
    ...
    if (domain == "fue.edu.eg") {
      final bool isStudent = RegExp(r'^\d{8}$').hasMatch(username);
    ...
    final customId = "$prefix$randomNumber";
    ...
    try {
      ...
      if (user != null) {
        ...
        await FirebaseFirestore.instance.collection('users').doc(user.uid).set({
          ...
          // STUDENT ID ONLY
          'studentId': userRole == "student" ? username : null,
          ...
          // APPROVAL SYSTEM
          'approvalStatus': userRole == "company" ? "pending" : "approved",
                      ...
                      children: [
                        ActionChip(
                          ...
                          onPressed: () {
                            ...
                            if (!current.contains('@')) {
                              setState(() {
                                _emailController.text = "$current@fue.edu.eg";
                              });
                            }
                          },
                        ),
